 ...
 *     name: depth
 *     in: query
 *     description: "The value must be 1 or 2"
 *     required: false
 *     schema:
 *       type: number
 *       enum: [1,2]
 ...
 *
 *   manuscriptIdentifierName:
 *    name: identifierName
 *    in: query
 *    schema:
 *      type: string
 *      enum: [doi,submissionId,submissionSystemId,contributorsEmail]
 *      description: Name of the manuscript identifier.
 *
 ...
 *     name: region
 *     in: query
 *     description: "Valid ISO2 country code to restrict parts data from"
 *     required: false
 *     schema:
 *       type: string
 */
