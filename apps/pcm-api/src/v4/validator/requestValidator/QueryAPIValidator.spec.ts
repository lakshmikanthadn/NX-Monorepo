...
describe('QueryAPIValidator', () => {
  describe('validateSearch', () => {
    ...
    it(`should throw Invalid offset in search query when request has offsetCursor as last-page-cursor
        and offset=30`, (done) => {
      request.body.offsetCursor = 'last-page-cursor';
    ...
    it(`should throw Invalid offset in search query when request has offsetCursor as invalid value and offset=30`, (done) => {
    ...
    it(`should throw Invalid offset in search query when request has offsetCursor as valid value and offset=30`, (done) => {
      request.body.offsetCursor =
        '6d4fb6ac-55f9-4a7a-9cfb-81085a8a6896:6d4fb6ac-55f9-4a7a-9cfb-81085a8a6898:6d4fb6ac-55f9-4a7a-9cfb-81085a8a6898_desc';
      request.body.offset = 30;
      try {
        queryAPIValidator.validateSearch(request);
        done(new Error('Expecting error, but got success'));
    ...
    // needs to enable once we accept multiple rules in request
    it.skip('should throw Invalid or missing search rules when rulesList is an empty array', (done) => {
    ...
    // needs to be enable once we accept multiple rules in one query
    it.skip('should throw Invalid search query. duplicate rules passed for the same type', (done) => {
      request.body.rulesList.push({
        attributes: [
          {
            name: 'title',
