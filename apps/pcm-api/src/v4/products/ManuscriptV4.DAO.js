...
exports.manuscriptV4DAO = void 0;
var MongoConnectionUtils_1 = require("../utils/MongoConnectionUtils");
...
var log = LoggerUtil_1.default.getLogger('ManuscriptV4DAO');
var ManuscriptV4DAO = /** @class */ (function () {
    function ManuscriptV4DAO() {
        this.productModelsHolder = {};
    }
    ManuscriptV4DAO.prototype.getManuscript = function (productType, id, projectionFields, availabilityName, availabilityStatus, productVersion, region) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                log.debug('getManuscript:: ', { projections: projections, query: query });
                return [2 /*return*/, model.findOne(query, projections).lean().exec()];
            });
        });
    };
    ManuscriptV4DAO.prototype.getProductModel = function (productType) {
        ...
        if (this.productModelsHolder[productTypeLowerCase]) {
            ...
            var newProductModel = MongoConnectionUtils_1.hubDBConnection.model(productType, GenricSchema_1.GenricSchema, docTypeToCollectionMapperV4[productTypeLowerCase]);
            this.productModelsHolder[productTypeLowerCase] = newProductModel;
            return newProductModel;
        }
    };
    ManuscriptV4DAO.prototype.prepareMongoProjections = function (projectionFields) {
    ...
    return ManuscriptV4DAO;
}());
exports.manuscriptV4DAO = new ManuscriptV4DAO();
