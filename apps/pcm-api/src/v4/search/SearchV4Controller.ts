...
import { ISearchRespMetadata } from '../model/interfaces/SearchResult';
...
class SearchV4Controller {
  ...
  public async searchProducts(
    ...
    try {
      ...
      const searchQuery: GroupedSearchQuery[] = searchPayload.rulesList;
      ...
      const availability = searchPayload.availability;
  ...
  public async parseSearchQuery(
    ...
    try {
      const searchQueryParserResult = this.mapAndParseSearchQuery(
        request.body.rulesList
      );
  ...
  public mapAndParseSearchQuery(
    searchQueries: GroupedSearchQuery[]
  ): GroupedSearchQuery[] {
    return queryParserV4.parse(searchQueries);
  }
}
