...
const devConfigProperties = {
  ...
  entitlementUrl:
    'http://entitlement-management-service-dev.us-east-1.elasticbeanstalk.com/entitlements/grantTypes',
  envName: 'dev',
  eventStoreBucket: 's3-euw1-ap-pe-df-pch-events-store-d',
  featureToggles: {},
  hubDBSecretName: 'sm/euw1/appe/df/pch/pipeline/db/d',
  hubDbHost:
    'clu-df-pch-hub-dev-uat.iken9.mongodb.net/product-content-validation-store-d',
  iamEnv: 'dev',
  ...
  propertiesAPIUrl:
    'http://properties-api-prod.us-east-1.elasticbeanstalk.com/properties/CP_PARTIES/dev',
  ...
  storeDbHostJumpServer:
    'clu-df-pch-product-stor.iken9.mongodb.net/product-store-dev',
...
const uatConfigProperties = {
  ...
  entitlementUrl:
    'http://entitlementmanagementservice-nlb.fkq72acfuz.us-east-1.elasticbeanstalk.com/entitlements/grantTypes',
  entitlementUrlV4:
    'http://nlb-use1-ap-pe-ems-fat-api-u-98a3de22d27b61ac.elb.us-east-1.amazonaws.com/entitlements/all?productIds=',
  envName: 'uat',
  eventStoreBucket: 's3-euw1-ap-pe-df-pch-events-store-u',
  featureToggles: {},
  hubDBSecretName: 'sm/euw1/appe/df/pch/pipeline/db/u',
  hubDbHost:
    'clu-df-pch-hub-dev-uat.iken9.mongodb.net/product-content-validation-store-u',
  iamEnv: 'uat',
  journalProductEventQueue: {
    isFifoQueue: true,
  ...
  propertiesAPIUrl:
    'http://properties-api-prod.us-east-1.elasticbeanstalk.com/properties/CP_PARTIES/uat',
  publishingServiceProductEventQueue: {
    isFifoQueue: true,
  ...
  storeDbHostJumpServer:
    'clu-df-pch-product-stor.iken9.mongodb.net/product-store-uat',
...
const prodConfigProperties = {
  ...
  entitlementUrl:
    'http://entitlement-management-service-prod-blue.us-east-1.elasticbeanstalk.com/entitlements/grantTypes',
  entitlementUrlV4:
    'http://entitlements-fat-api-ubx2-prod.us-east-1.elasticbeanstalk.com/entitlements/all?productIds=',
  envName: 'prod',
  eventStoreBucket: 's3-euw1-ap-pe-df-pch-events-store-p',
  featureToggles: {},
  hubDBSecretName: 'sm/euw1/appe/df/pch/pipeline/db/p',
  hubDbHost:
    'clu-df-pch-hub-prod.kiz5p.mongodb.net/product-content-validation-store-p',
  iamEnv: 'prod',
  journalProductEventQueue: {
    isFifoQueue: true,
  ...
  propertiesAPIUrl:
    'http://properties-api-prod.us-east-1.elasticbeanstalk.com/properties/CP_PARTIES/prod',
  publishingServiceProductEventQueue: {
    isFifoQueue: true,
  ...
  storeDbHostJumpServer:
    'clu-df-pch-store-prod.kiz5p.mongodb.net/product-store-p',
...
const qaConfigProperties = {
  ...
  hubDbHost:
    'clu-df-pch-hub-dev-uat.iken9.mongodb.net/product-content-validation-store-q',
  iamEnv: 'uat',
  journalProductEventQueue: {
    isFifoQueue: true,
  ...
  storeDbHostJumpServer:
    'clu-df-pch-product-stor.iken9.mongodb.net/product-store-qa',
