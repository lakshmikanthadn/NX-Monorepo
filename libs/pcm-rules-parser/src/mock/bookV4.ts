    ...
    availability: [
      {
        errors: ['random'],
        name: 'UBX',
        status: ['SELLABLE', 'PUBLISHED', 'DRM_FREE', 'CAN_HOST']
      },
      {
        errors: ['random'],
        name: 'AGG',
        status: ['CAN_SEND_TO_AGG', 'SHOULD_NOTIFY']
      }
    ],
  ...
  },
  {
    ...
    availability: [
      ...
      },
      {
        errors: ['random'],
        name: 'AGG',
        status: ['CAN_SEND_TO_AGG', 'SHOULD_NOTIFY', 'SF-INACTIVE']
      }
    ],
    book: {
      abstracts: [
    ...
    availability: [
      {
        errors: ['random'],
        name: 'UBX',
        status: ['SELLABLE', 'PUBLISHED', 'DRM_FREE']
      },
      {
        errors: ['random'],
        name: 'AGG',
