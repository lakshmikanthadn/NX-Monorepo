...
// PromotionalMetaData
const PromotionalMetaData = new mongoose.Schema({
...
exports.Promotional = new mongoose.Schema(Object.assign(Object.assign({}, productV4_1.ProductSchemaProperties), { promotional: { required: true, type: PromotionalMetaData } }), productV4_1.schemaOptions);
